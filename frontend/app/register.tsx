...
export default function Register() {
  ...
  const handleRegister = async () => {
    ...
    if (res.ok) {
      ...
      setError(res.msg?.toUpperCase() || "ERROR DE REGISTRO");
    }
  };
        ...
        <View style={styles.screenBezel}>
          <ScrollView contentContainerStyle={styles.lcdContent} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.logoContainer}>
              <Text style={styles.logoText}>NUEVA CUENTA</Text>
            </View>
            ...
            <View style={styles.buttonContainer}>
              ...
              >
                <Text style={styles.secondaryBtnText}>¿YA TIENES CUENTA?</Text>
                <Text style={[styles.secondaryBtnText, {color: Colors.lcd.primary, marginTop: 4}]}>INICIA SESIÓN</Text>
              </TouchableOpacity>
            </View>
